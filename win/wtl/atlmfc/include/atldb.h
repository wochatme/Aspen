...
struct _Has_Fire_OnFieldChange : ::std::false_type {};

template<class T>
struct _Has_Fire_OnFieldChange<T, ::std::void_t<
...
#define _ATL_IF_EXISTS_FIRE_ON_FIELD_CHANGE if constexpr(_Has_Fire_OnFieldChange<T>::value)
...
*/
template<class T, class = void>
struct _Has_Fire_OnRowChange : ::std::false_type {};

template<class T>
struct _Has_Fire_OnRowChange<T, ::std::void_t<
...
#define _ATL_IF_EXISTS_FIRE_ON_ROW_CHANGE if constexpr(_Has_Fire_OnRowChange<T>::value)
...
*/
template<class T, class = void>
struct _Has_Fire_OnRowsetChange : ::std::false_type {};

template<class T>
struct _Has_Fire_OnRowsetChange<T, ::std::void_t<
...
#define _ATL_IF_EXISTS_FIRE_ON_ROWSET_CHANGE if constexpr(_Has_Fire_OnRowsetChange<T>::value)
...
*/
template<class T, class = void>
struct _Has_CreateAccessor : ::std::false_type {};

template<class T>
struct _Has_CreateAccessor<T, ::std::void_t<
...
EXIT:
		...
		_Inout_ DBPROP* pDBProp)
	{
		...
		if constexpr (_Has_CreateAccessor<T>::value)
		{
			ATLENSURE_RETURN(pDBProp != NULL);
...
*/
template<class T, class = void>
struct _Has_GetRowsAt : ::std::false_type {};

template<class T>
struct _Has_GetRowsAt<T, ::std::void_t<
		...
		for (DBCOUNTITEM l=0; l<cRows; l++)
		{
			...
			else
			{
				...
				else
				{
					...
					if constexpr(_Has_GetRowsAt<T>::value)
					{
 ...
 */
template<class T, class = void>
struct _Has_InsertRow : ::std::false_type {};

template<class T>
struct _Has_InsertRow<T, ::std::void_t<
...
public:
		...
		_In_ HROW hThatRow)
	{
		...
		if constexpr(_Has_InsertRow<T>::value)
		{
