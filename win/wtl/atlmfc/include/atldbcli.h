...
public:
	...
	DBBLOBHANDLINGENUM GetBlobHandling() const
	{
	...
	DBLENGTH GetBlobSizeLimit() const
	{
		return m_nBlobSize;
	}
...
struct _Has_m_nAccessors : ::std::false_type {};

template<class T>
struct _Has_m_nAccessors<T, ::std::void_t<decltype(::std::declval<T>().m_nAccessors)>> : ::std::true_type {};
...
public:
	...
	CAccessorRowset()
	{
		...
		{
			static_cast<_Self*>(this)->SetAccessor(this);
		}
	}
	~CAccessorRowset()
	{
...
public:
	...
	bool Find(_In_z_ const TCHAR* szSearchName) throw()
	{
