...
template <class T>
struct _Has_GetAttrEntries<T, ::std::enable_if_t<::std::is_same_v<const ATL::_ATL_INTMAP_ENTRY*, decltype(T::_GetAttrEntries())>>> : ::std::true_type{};
...
#define COM_INTERFACE_ENTRY_BREAK(x)\
	{&_ATL_IIDOF(x), \
	NULL, \
	ATL::CComObjectRootBase::_Break},
#endif // _ATL_USE_WINAPI_FAMILY_DESKTOP_APP

#define COM_INTERFACE_ENTRY_NOINTERFACE(x)\
	{&_ATL_IIDOF(x), \
	NULL, \
	ATL::CComObjectRootBase::_NoInterface},
...
#define COM_INTERFACE_ENTRY_TEAR_OFF(iid, x)\
	...
	(DWORD_PTR)&ATL::_CComCreatorData<\
		...
		>::data,\
	ATL::CComObjectRootBase::_Creator},
...
template <class T>
struct _Has_GetAttrConnMap<T, ::std::enable_if_t<::std::is_same_v<const ATL::_ATL_CONNMAP_ENTRY*, decltype(T::GetAttrConnMap(::std::declval<int*>()))>>> : ::std::true_type{};
