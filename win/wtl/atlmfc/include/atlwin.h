...
struct _Has_GetSinkMapFinder : ::std::false_type {};

template<class T>
struct _Has_GetSinkMapFinder<T, ::std::void_t<typename T::_GetSinkMapFinder>> : ::std::true_type {};
...
// Event handling support and Message map
	HRESULT AdviseSinkMap(_In_ bool bAdvise)
	{
		...
		if constexpr(_Has_GetSinkMapFinder<T>::value)
		{
