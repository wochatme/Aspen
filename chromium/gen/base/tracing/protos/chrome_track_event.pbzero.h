...
constexpr EventTiming_EventType EventTiming_EventType_MAX = EventTiming_EventType::DROP_EVENT;
...
constexpr ChromeLatencyInfo2_Step ChromeLatencyInfo2_Step_MAX = ChromeLatencyInfo2_Step::STEP_RESAMPLE_SCROLL_EVENTS;
...
constexpr ChromeGraphicsPipeline_StepName ChromeGraphicsPipeline_StepName_MAX = ChromeGraphicsPipeline_StepName::STEP_DRAW_AND_SWAP;
...
constexpr SequenceManagerTask_QueueName SequenceManagerTask_QueueName_MAX = SequenceManagerTask_QueueName::V8_BEST_EFFORT_TQ;
...
constexpr RendererMainThreadTaskExecution_TaskType RendererMainThreadTaskExecution_TaskType_MAX = RendererMainThreadTaskExecution_TaskType::TASK_TYPE_MAIN_THREAD_TASK_QUEUE_V8_BEST_EFFORT;
...
class EventTiming_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/9, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
...
class ChromeLatencyInfo2_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/10, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
...
class ChromeLatencyInfo2_ComponentInfo_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
...
class MainFramePipeline_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/5, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
...
class BeginFrameId_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
...
class ScrollMetrics_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/6, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
...
class ChromeGraphicsPipeline_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/9, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
  ...
  bool has_aggregated_frames_ids() const { return at<8>().valid(); }
  ::protozero::RepeatedFieldIterator<int64_t> aggregated_frames_ids() const { return GetRepeated<int64_t>(8); }
...
class ChromeGraphicsPipeline : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_AggregatedFramesIds =
    ::protozero::proto_utils::FieldMetadata<
      8,
      ::protozero::proto_utils::RepetitionType::kRepeatedNotPacked,
      ::protozero::proto_utils::ProtoSchemaType::kInt64,
  ...
  static constexpr FieldMetadata_AggregatedFramesIds kAggregatedFramesIds{};
  void add_aggregated_frames_ids(int64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_AggregatedFramesIds::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kInt64>
